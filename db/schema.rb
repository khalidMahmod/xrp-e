...
ActiveRecord::Schema.define(version: 20180312121902) do
  ...
  create_table "account_versions", force: :cascade do |t|
    ...
    t.decimal  "fees",                        precision: 32, scale: 16
  ...
  create_table "api_tokens", force: :cascade do |t|
    ...
    t.string   "access_key",      limit: 100, default: "", null: false
    t.string   "secret_key",      limit: 100, default: "", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "currency_amounts", force: :cascade do |t|
    ...
    t.decimal  "deposit_fee",              precision: 32, scale: 16
    t.decimal  "withdraw_fee",             precision: 32, scale: 16
  end
  ...
  create_table "login_histories", force: :cascade do |t|
    ...
    t.string   "browser_info", limit: 255
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.boolean  "fa_enable",                 default: false
    t.string   "signature",     limit: 100
    t.integer  "is_disabled",   limit: 4,   default: 0
    t.datetime "disable_time"
  end
  ...
  create_table "trade_fees", force: :cascade do |t|
    t.string  "code_id",    limit: 255
    t.integer "code",       limit: 4
    t.string  "base_unit",  limit: 255
    t.string  "quote_unit", limit: 255
    t.integer "sort_order", limit: 4
    t.decimal "fee",                    precision: 32, scale: 4
    t.string  "currency",   limit: 255
    t.string  "trade_info", limit: 255
  end
